...
%>
    ...
    <h3>Controlled Drug Record | Area: <%out.print(wardName);%></h3>
    <h4>Logged in as: <%out.print(session.getAttribute("user"));%> | User Level: <%out.print(session.getAttribute("userLevel"));%></h4>
